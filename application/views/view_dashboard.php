	...
	<div class="container">
		<div id="search_wrapper">
		 ...
		 <h1>Cari pekerjaan impianmu</h1>
		    <p>
			 <input type="text" class="text" placeholder=" " value="Masukkan Nama Pekerjaan" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Enter Keyword(s)';}">
			 <input type="text" class="text" placeholder=" " value="Lokasi" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Location';}">
			 <label class="btn2 btn-2 btn2-1b"><input type="submit" value="Cari"></label>
			</p>
            <h2 class="title">Daerah yang sering dikunjungi</h2>
         </div>
		 <div id="city_1" class="clearfix">
		   <ul class="orange">
			 <!-- <li>
			  ...
			  <li>
			 	<a href="#" title="Pharma"><?php echo $prop->nama_provinsi?></a>
			 </li>
			 <?php }?> -->
			 </ul>
	     </div>
...
<div class="container">
  <div class="grid_1">
	 <h3>Supported By</h3>
	   <ul id="flexiselDemo3">
	      <li><img src="<?php echo base_url().'web/'?>images/c1.gif"  class="img-responsive" /></li>
		  <li><img src="<?php echo base_url().'web/'?>images/c2.gif"  class="img-responsive" /></li>
		  <li><img src="<?php echo base_url().'web/'?>images/c3.gif"  class="img-responsive" /></li>
		  <li><img src="<?php echo base_url().'web/'?>images/c4.gif"  class="img-responsive" /></li>
		  <li><img src="<?php echo base_url().'web/'?>images/c5.gif"  class="img-responsive" /></li>
		  <li><img src="<?php echo base_url().'web/'?>images/c6.gif"  class="img-responsive" /></li>	
	    </ul>
	 ...
	 <div class="single">  
	   <div class="col-md-4">
	   	  <div class="col_3">
	   	  	<h3>Pekerjaan Yang Banyak Dicari</h3>
	   	  	<ul class="list_1">
	   	  ...
	   	  <div class="col_3">
	   	  	<h3>Pekerjaan Berdasarkan Kategori</h3>
	   	  	<ul class="list_2">
	   	  		<?php foreach ($kategori_pekerjaan as $kategori) { ?>
	   	  		<li><a href="#"><?php echo $kategori->nama_kategori_pekerjaan?></a></li>
	   	  		<?php }?>							
	   	  	</ul>
	   	  </div>
	   ...
	   <div class="col-md-8">
	      <div class="col_1">
   	        <div class="col-sm-4 row_2">
				<a href="single.html"><img src="<?php echo base_url().'web/'?>images/a1.jpg" class="img-responsive" alt=""/></a>
			</div>
		   ...
		   <div class="col_1">
   	         <div class="col-sm-4 row_2">
				<a href="single.html"><img src="<?php echo base_url().'web/'?>images/a2.jpg" class="img-responsive" alt=""/></a>
			</div>
			<div class="col-sm-8 row_1">
		   ...
		   <div class="col_1">
   	        <div class="col-sm-4 row_2">
				<a href="single.html"><img src="<?php echo base_url().'web/'?>images/a3.jpg" class="img-responsive" alt=""/></a>
			</div>
			<div class="col-sm-8 row_1">
		   ...
		   <div class="col_1">
   	         <div class="col-sm-4 row_2">
				<a href="single.html"><img src="<?php echo base_url().'web/'?>images/a4.jpg" class="img-responsive" alt=""/></a>
			</div>
			<div class="col-sm-8 row_1">
		   ...
		   <div class="col_1">
   	         <div class="col-sm-4 row_2">
				<a href="single.html"><img src="<?php echo base_url().'web/'?>images/a5.jpg" class="img-responsive" alt=""/></a>
			</div>
			<div class="col-sm-8 row_1">
		   ...
		   <div class="col_2">
   	         <div class="col-sm-4 row_2">
				<a href="single.html"><img src="<?php echo base_url().'web/'?>images/a6.jpg" class="img-responsive" alt=""/></a>
			</div>
			<div class="col-sm-8 row_1">
