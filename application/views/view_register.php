...
<div class="container">
    <div class="single">  
	   <div class="form-container">
        ...
        <form action="<?php echo site_url('register/tambah_member')?>" method="post">
         ...
         <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-9">
                    <input type="number" name="nomor_telepon" class="form-control input-sm"/>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-12">
                <label class="col-md-3 control-lable" for="lastName">Alamat Member</label>
                <div class="col-md-9">
                     <input type="text" name="alamat_member" class="form-control input-sm"/>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-12">
                <label class="col-md-3 control-lable" for="lastName">Jenis Kelamin Member</label>
                <div class="col-md-9">
                     <select class="selectpicker form-control" name="jenis_kelamin_member">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                <label class="col-md-3 control-lable" for="dob">Tanggal Lahir Member</label>
                <div class="col-md-9">
                    <input type="text" name="tanggal_lahir_member" id="datepicker" class="form-control input-sm"/>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-12">
                <label class="col-md-3 control-lable" for="email">Jenis Member</label>
                <div class="col-md-9">
                    <select class="selectpicker form-control" name="jenis_member">
