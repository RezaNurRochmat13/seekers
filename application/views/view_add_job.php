...
<link rel="stylesheet" href="<?php echo base_url().'web/'?>css/jquery-ui.css">
<!----font-Awesome----->
...
<div class="container">
    <div class="single">  
	   <div class="form-container">
        ...
        <form action="<?php echo site_url('job/tambah_lowongan')?>" method="post">
        	 <div class="row">
            <div class="form-group col-md-12">
                <label class="col-md-3 control-lable" for="lastName">Nama Pekerjaan</label>
                <div class="col-md-9">
                    <input type="text" name="nama_pekerjaan" class="form-control input-sm"/>
                </div>
            </div>
        </div>
        	 <div class="row">
            <div class="form-group col-md-12">
                <label class="col-md-3 control-lable" for="lastName">Deskripsi Pekerjaan</label>
                <div class="col-md-9">
                    <input type="text" name="deskripsi_pekerjaan" class="form-control input-sm"/>
                </div>
            </div>
        </div>
         <div class="row">
            <div class="form-group col-md-12">
                <label class="col-md-3 control-lable" for="lastName">Maksimal Tanggal</label>
                <div class="col-md-9">
                    <input type="date" name="lama_pengerjaan" id="datepicker" class="form-control input-sm"/>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="form-group col-md-12">
                <label class="col-md-3 control-lable" for="lastName">Kategori Pekerjaan</label>
                <div class="col-md-9">
                     <select class="selectpicker form-control" name="kode_kategori_pekerjaan" required>
                     	<?php foreach($kategori as $data){?>
			        <option value="<?php echo $data->kode_kategori_pekerjaan?>"><?php echo $data->nama_kategori_pekerjaan?></option>
			        <?php }?>
			      </select>
                </div>
            </div>
         ...
         <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-9">
                     <select class="selectpicker form-control" name="kode_member" required>
                     	<?php foreach($member as $membr){ ?>
			        <option value="<?php echo $membr->kode_member?>"><?php echo $membr->nama_member?></option>
			        <?php }?>
			      </select>
                </div>
            </div>
...
<script src="<?php echo base_url().'web/'?>js/jquery-1.12.4.js"></script>
